...
let font = `./GmarketSansTTFMedium.ttf`;
Canvas.registerFont(font, 'GmarketSans')
	...
	try {
		...
		return new Canvas(canvas.width, canvas.height) // 배경 크기
			...
			.setColor('#ffffff').setTextFont('25pt GmarketSans').addText(`닉네임: ${name}`, 230, 70)
								.setTextFont('18pt GmarketSans').addText(`가장 높은 역할: ${data.HighestRole}`, 230, 70 + 50 + 10)
																.addText(`모든 역할: ${roles}`, 230, 70 + 50 + 50 + 5)
...
module.exports.core = async (client, message, args) => {
...
module.exports.run = async (client, message, args) => {
    await module.exports.core(client, message, args);
};

module.exports.help = {
    name: "userinfo2",
    aliases: ["i2", "ui2", "ㅕㅑ2", "ㅑ2", "내정보2", "유저정보2"],
    category: "정보"
}